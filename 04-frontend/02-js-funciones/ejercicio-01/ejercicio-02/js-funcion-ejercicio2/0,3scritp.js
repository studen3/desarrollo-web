...
console.log(devolverString("cluhouse"));
...
console.log(menosQueNoventa(50, 55));
...
console.log(obtenerAreaRectangulo(32, 22));
...
console.log(deEuroAdolar(3.500));
